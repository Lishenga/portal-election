            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3">
                         ...
                         @include('election.election.create')
                            ...
                            <table id="datatable" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                ...
                                @foreach($customers as $customer)  
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn waves-effect waves-light btn-primary" href="{{url('election/view/details')}}?id={{$customer->id}}"> <i class="fa fa-pencil"></i></a>
                                            <a href="{{url('/election/delete')}}?id={{$customer->id}}" onclick="alert('Are you sure you want to block {{@$customer->name }}?')" class="btn waves-effect waves-light btn-danger"> <i class="fa fa-remove"></i> </a>
                                        </td>
                                    </tr>
